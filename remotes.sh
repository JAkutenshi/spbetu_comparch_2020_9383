git remote add FollowJust                     https://github.com/FollowJust/spbetu_comparch_2020_9383.git               # Гладких
git remote add Hotiakov                       https://github.com/Hotiakov/spbetu_comparch_2020_9383.git                 # Хотяков
git remote add KamzolovNikita                 https://github.com/KamzolovNikita/spbetu_comparch_2020_9383.git           # Камзолов
...
git remote add emptyfs                        https://github.com/emptyfs/spbetu_comparch_2020_9383.git                  # Корсунов
